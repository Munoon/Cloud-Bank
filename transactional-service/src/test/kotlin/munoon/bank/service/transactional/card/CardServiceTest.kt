...
internal class CardServiceTest : AbstractTest() {
    ...
    fun buyPaymentCard() {
        ...
        val expectedTransaction = UserTransaction(page.content[0].id, defaultCard.copy(balance = 900.0), 100.0, 900.0, UserTransactionType.CARD_BUY, BuyCardUserTransactionInfo(goldCard))
