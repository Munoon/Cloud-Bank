...
internal class CardMapperTest {
    ...
    fun updateCardByAdmin() {
        val card = Card("CARD_ID", 100, "default", "123456789012", "1111", 100.0, LocalDateTime.now())
        val update = AdminUpdateCardTo(101, "gold", "111111111111")
    ...
    fun createCardByAdmin() {
        val actual = CardMapper.INSTANCE.asCard(
                AdminCreateCardTo(100, "default", "123456789012", "1111"),
                NoOpPasswordEncoder.getInstance()
        )
        val expected = Card(null, 100, "default", "123456789012", "{noop}1111", 0.0, LocalDateTime.now())
        assertMatch(actual, expected)
    }
    ...
    fun buyCard() {
        ...
        val expected = Card(null, 100, "default", null, "2222", 0.0, LocalDateTime.now())
