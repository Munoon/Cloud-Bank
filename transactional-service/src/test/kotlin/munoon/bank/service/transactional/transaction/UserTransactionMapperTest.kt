...
internal class UserTransactionMapperTest : AbstractTest() {
    ...
    fun asTo() {
        ...
        val transaction = UserTransaction("123", card, 10.0, 100.0, 110.0, LocalDateTime.now(), UserTransactionType.FINE, FineUserTransactionInfo(101, "test"))
        val expected = UserTransactionTo("123", cardMapper.asTo(card, UserTestData.DEFAULT_USER_TO), 10.0, 100.0, 110.0, LocalDateTime.now(), UserTransactionType.FINE, FineUserTransactionInfoTo(user101, "test"))
    ...
    fun asToPage() {
        ...
        val transaction2 = UserTransaction("321", card, 10.0, 100.0, 110.0, LocalDateTime.now(), UserTransactionType.AWARD, AwardUserTransactionInfo(101, "test2"))
        val expected2 = UserTransactionTo("321", cardMapper.asTo(card, UserTestData.DEFAULT_USER_TO), 10.0, 100.0, 110.0, LocalDateTime.now(), UserTransactionType.AWARD, AwardUserTransactionInfoTo(user101, "test2"))
    ...
    fun buyCardAsTo() {
        val card = Card("111", 100, "default", "111111111111", "1111", 100.0, true, LocalDateTime.now())
        val transaction = UserTransaction("123", card, 10.0, 100.0, 110.0, LocalDateTime.now(), UserTransactionType.FINE, BuyCardUserTransactionInfo(card))
        val expected = UserTransactionTo("123", cardMapper.asTo(card, UserTestData.DEFAULT_USER_TO), 10.0, 100.0, 110.0, LocalDateTime.now(), UserTransactionType.FINE, BuyCardUserTransactionInfoTo(cardMapper.asTo(card)))
        assertMatch(userTransactionMapper.asTo(transaction), expected)
        verify(userService, times(1)).getUsersById(anySet())
    }
    ...
    fun awardAsTo() {
        val card = Card("111", 100, "default", "111111111111", "1111", 100.0, true, LocalDateTime.now())
        val transaction = UserTransaction("123", card, 10.0, 100.0, 110.0, LocalDateTime.now(), UserTransactionType.FINE, AwardUserTransactionInfo(101, "test"))
        val expected = UserTransactionTo("123", cardMapper.asTo(card, UserTestData.DEFAULT_USER_TO), 10.0, 100.0, 110.0, LocalDateTime.now(), UserTransactionType.FINE, AwardUserTransactionInfoTo(user101, "test"))
        assertMatch(userTransactionMapper.asTo(transaction), expected)
        verify(userService, times(1)).getUsersById(anySet())
    }
