...
internal class UserTransactionMapperTest : AbstractTest() {
    ...
    fun asTo() {
        ...
        val expected = UserTransactionTo("123", cardMapper.asTo(card, UserTestData.DEFAULT_USER_TO), 10.0, 110.0, LocalDateTime.now(), UserTransactionType.FINE, FineUserTransactionInfoTo(user101, "test", 100.0))
    ...
    fun asToPage() {
        ...
        val transaction2 = UserTransaction("321", card, 10.0, 110.0, LocalDateTime.now(), UserTransactionType.AWARD, AwardUserTransactionInfo(101, "test2", 100.0))
        val expected2 = UserTransactionTo("321", cardMapper.asTo(card, UserTestData.DEFAULT_USER_TO), 10.0, 110.0, LocalDateTime.now(), UserTransactionType.AWARD, AwardUserTransactionInfoTo(user101, "test2", 100.0))
    ...
    fun buyCardAsTo() {
        val card = Card("111", 100, "default", "111111111111", "1111", 100.0, true, LocalDateTime.now())
        val transaction = UserTransaction("123", card, 10.0, 110.0, LocalDateTime.now(), UserTransactionType.FINE, BuyCardUserTransactionInfo(card, 100.0))
        val expected = UserTransactionTo("123", cardMapper.asTo(card, UserTestData.DEFAULT_USER_TO), 10.0, 110.0, LocalDateTime.now(), UserTransactionType.FINE, BuyCardUserTransactionInfoTo(cardMapper.asTo(card), 100.0))
        assertMatch(userTransactionMapper.asTo(transaction), expected)
        verify(userService, times(1)).getUsersById(anySet())
    }
    ...
    fun awardAsTo() {
        val card = Card("111", 100, "default", "111111111111", "1111", 100.0, true, LocalDateTime.now())
        val transaction = UserTransaction("123", card, 10.0, 110.0, LocalDateTime.now(), UserTransactionType.FINE, AwardUserTransactionInfo(101, "test", 100.0))
        val expected = UserTransactionTo("123", cardMapper.asTo(card, UserTestData.DEFAULT_USER_TO), 10.0, 110.0, LocalDateTime.now(), UserTransactionType.FINE, AwardUserTransactionInfoTo(user101, "test", 100.0))
        assertMatch(userTransactionMapper.asTo(transaction), expected)
        verify(userService, times(1)).getUsersById(anySet())
    }
