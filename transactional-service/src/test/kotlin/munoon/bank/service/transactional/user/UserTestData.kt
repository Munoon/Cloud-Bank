...
object UserTestData {
    ...
    val DEFAULT_USER = User(USER_ID, "Nikita", "Ivchenko", "munoon", "{noop}password", "10", 100.0, LocalDateTime.now(), hashSetOf(UserRoles.ROLE_ADMIN, UserRoles.ROLE_BARMEN, UserRoles.ROLE_COURIER, UserRoles.ROLE_TEACHER))
